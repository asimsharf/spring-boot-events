...
public class UploadedFileRequest {
    ...
    public UploadedFileRequest(Long id, String fileName, String fileType, String filePath, Long fileSize,
    ...
    public UploadedFileRequest(String fileName, String fileType, String filePath, Long fileSize,
            String fileDownloadUri, String fileExtension, RequiredDocument requiredDocument, boolean isRequired) {
        this.fileName = fileName;
        this.fileType = fileType;
        this.filePath = filePath;
